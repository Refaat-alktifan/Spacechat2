package com.example.refaat.myapplication.ui;
...
import com.example.refaat.myapplication.adapter.UsersChatAdapter;
 import com.example.refaat.myapplication.login.LogInActivity;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  go =(Icon) findViewById(R.id.gobtn);
        ...
        if(item.getItemId()==R.id.action_logout){
            ...
            switch (item.getItemId()){
                ...
                case R.id.action_example:
                    Intent intent1 = new Intent(this,UsersChatAdapter.class);
