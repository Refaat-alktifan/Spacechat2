package com.example.refaat.myapplication.adapter;
...
import com.example.refaat.myapplication.FireChatHelper.ChatHelper;
import com.example.refaat.myapplication.FireChatHelper.ExtraIntent;
import com.example.refaat.myapplication.R;
import com.example.refaat.myapplication.model.User;
import com.example.refaat.myapplication.ui.ChatActivity;
...
public class UsersChatAdapter extends RecyclerView.Adapter<UsersChatAdapter.ViewHolderUsers> {
    ...
    public UsersChatAdapter(Context context, ArrayList<User> fireChatUsers) {
